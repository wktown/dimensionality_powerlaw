from activation_models.AtlasNet.layer_operations.filters import filters
from activation_models.AtlasNet.layer_operations.nonlinearity import nonlinearity
